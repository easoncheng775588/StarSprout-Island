...
values ('math-numbers-001', '认识 0-10', '数字小探险', 'recommended', '拖一拖、选一选，把数字和数量变成好朋友。', 3, '数字小达人', 1, 'math-numbers'),
       ...
       ('chinese-pinyin-001', '拼音泡泡', '拼音泡泡大作战', 'available', '听一听、认一认，把声母和韵母连起来。', 1, '拼音小耳朵', 3, 'chinese-characters'),
       ('chinese-pinyin-002', '拼读小火车', '拼读小火车', 'available', '把拼读的声音和拼音火车连起来。', 2, '拼读小火车长', 4, 'chinese-characters'),
       ('chinese-strokes-001', '笔顺小画家', '笔顺小画家', 'available', '按顺序点一点，把汉字的笔画排整齐。', 2, '笔顺小画家', 5, 'chinese-characters'),
       ('chinese-strokes-002', '日字描描乐', '日字描描乐', 'available', '继续按顺序点一点，把“日”字写完整。', 2, '小小写字家', 6, 'chinese-characters'),
       ...
       ('english-phonics-001', '字母藏在单词里', '字母藏在单词里', 'available', '听字母声音，再找出发音一样的单词。', 2, '拼读小船员', 5, 'english-letters'),
       ('english-words-001', '日常单词配对', '单词海风配对赛', 'available', '把常见生活单词和图像轻松对应起来。', 1, '单词小海星', 6, 'english-letters'),
       ('english-words-002', '生活单词跟读', '生活单词跟读', 'available', '边配对边跟读，把常见生活单词读出来。', 2, '单词跟读手', 7, 'english-letters'),
       ('english-story-001', '海湾小绘本', '海湾小绘本', 'available', '跟着图片读一读简单句子，把小故事完整读下来。', 2, '绘本小海鸥', 8, 'english-letters'),
       ('english-story-002', '晨光小绘本', '晨光小绘本', 'available', '继续跟着图片读一读简单句子。', 2, '晨光朗读员', 9, 'english-letters');
...
values (1, 'step-1', 'drag-match', '把 5 个苹果拖进篮子', 1, 'math-numbers-001'),
       ...
       (16, 'step-1', 'listen-choice', '听一听，选出读音正确的拼音泡泡', 1, 'chinese-pinyin-001'),
       (17, 'step-1', 'listen-choice', '听老师读，选出正确的拼读小火车', 1, 'chinese-pinyin-002'),
       (18, 'step-1', 'stroke-order', '按笔顺点出“口”的三笔', 1, 'chinese-strokes-001'),
       (19, 'step-1', 'stroke-order', '按笔顺点出“日”的四笔', 1, 'chinese-strokes-002'),
       (20, 'step-1', 'follow-read', '跟读 A、B、C、D、E、F', 1, 'english-letters-001'),
       (21, 'step-1', 'follow-read', '跟读 G、H、I、J、K、L', 1, 'english-letters-002'),
       (22, 'step-1', 'follow-read', '跟读 M、N、O、P、Q、R', 1, 'english-letters-003'),
       (23, 'step-1', 'follow-read', '跟读 S、T、U、V、W、X、Y、Z', 1, 'english-letters-004'),
       (24, 'step-1', 'listen-choice', '听一听 /b/ 的声音，找到正确单词', 1, 'english-phonics-001'),
       (25, 'step-1', 'drag-match', '把 apple、book、cat 和图片连起来', 1, 'english-words-001'),
       (26, 'step-1', 'drag-match', '把 sun、bag、milk 和图片连起来', 1, 'english-words-002'),
       (27, 'step-1', 'sentence-read', '按顺序读完这三句小绘本', 1, 'english-story-001'),
       (28, 'step-1', 'sentence-read', '按顺序读完晨光小绘本', 1, 'english-story-002');
