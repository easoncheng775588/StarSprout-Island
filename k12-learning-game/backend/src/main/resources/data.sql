...
values ('math-numbers-001', '认识 0-10', '数字小探险', 'recommended', '拖一拖、选一选，把数字和数量变成好朋友。', 3, '数字小达人', 1, 'math-numbers'),
       ...
       ('math-subitizing-001', '一眼看数量', '一眼看数量', 'available', '把小圆点看成几组，不用一个个数也能快速看出总数。', 2, '数感闪电眼', 15, 'math-numbers'),
       ('math-part-whole-001', '数字分合小屋', '数字分合小屋', 'available', '观察数字小屋，理解一个数可以分成两个部分。', 2, '分合小建筑师', 16, 'math-numbers'),
       ('math-picture-addition-001', '看图加法故事', '看图加法故事', 'available', '先看图讲出加法故事，再把总数算出来。', 2, '看图列式星', 17, 'math-numbers'),
       ...
       ('math-grade1-money-001', '人民币小商店', '人民币小商店', 'available', '认识元和简单付钱情境，把加法放进小商店里。', 3, '小小收银员', 3, 'math-grade1-life'),
       ('math-grade1-time-001', '整点时间站', '整点时间站', 'available', '认识整点和经过时间，把时钟上的变化说清楚。', 3, '整点小管家', 4, 'math-grade1-life'),
       ('math-grade1-shape-001', '图形拼拼站', '图形拼拼站', 'available', '观察三角形、长方形和正方形，试着把图形拼出来。', 3, '图形拼搭星', 5, 'math-grade1-life'),
       ...
       ('chinese-grade1-finals-001', '韵母听辨站', '韵母听辨站', 'available', '听一听常见韵母，把拼读声音分清楚。', 2, '韵母小耳朵', 3, 'chinese-grade1-words'),
       ('chinese-grade1-measure-word-001', '量词搭配桥', '量词搭配桥', 'available', '把常见名词和合适的量词搭起来。', 2, '量词搭配星', 4, 'chinese-grade1-words'),
       ...
       ('chinese-grade1-picture-speaking-001', '看图说一句', '看图说一句', 'available', '看图读句，再试着把一句话说完整。', 2, '看图表达星', 3, 'chinese-grade1-reading'),
       ...
       ('english-grade1-short-vowel-001', '短元音听辨', '短元音听辨', 'available', '听短元音，把 cat、bed、pig 这类单词开口读准。', 2, '短元音小耳朵', 3, 'english-grade1-words'),
       ('english-grade1-number-color-001', '数字颜色配对', '数字颜色配对', 'available', '把数字、颜色和图标配起来，建立一年级常用词。', 2, '数字颜色星', 4, 'english-grade1-words'),
       ...
       ('english-grade1-dialogue-001', '课堂对话跟读', '课堂对话跟读', 'available', '跟读课堂里的常用短句，敢把英语说出口。', 2, '课堂表达星', 3, 'english-grade1-sentences'),
       ...
       ('math-grade2-division-001', '除法平均分', '除法平均分', 'available', '把物品平均分给几个人，看懂除法的意义。', 3, '平均分小队长', 4, 'math-grade2-skills'),
       ('math-grade2-statistics-001', '统计图读数', '统计图读数', 'available', '读懂简单统计图，比较哪一类最多。', 3, '统计观察星', 5, 'math-grade2-skills'),
       ...
       ('chinese-grade2-punctuation-001', '标点语气站', '标点语气站', 'available', '根据句子的语气，选择更合适的标点。', 2, '语气小侦探', 3, 'chinese-grade2-words'),
       ...
       ('chinese-grade2-main-idea-001', '中心句小雷达', '中心句小雷达', 'available', '读一小段话，找到最能概括意思的句子。', 2, '中心句雷达', 3, 'chinese-grade2-reading'),
       ...
       ('english-grade2-food-listening-001', '食物单词听辨', '食物单词听辨', 'available', '听食物单词，选出正确的词卡。', 2, '食物听辨星', 3, 'english-grade2-phonics'),
       ...
       ('english-grade2-animal-dialogue-001', '动物对话跟读', '动物对话跟读', 'available', '围绕喜欢的动物，跟读简单问答。', 2, '动物对话星', 3, 'english-grade2-story'),
       ...
       ('math-grade3-remainder-001', '有余数除法', '有余数除法', 'available', '把不能正好分完的数量说清楚，认识余数。', 3, '余数观察星', 4, 'math-grade3-operations'),
       ('math-grade3-area-001', '长方形面积', '长方形面积', 'available', '用长和宽组成面积模型，理解长方形面积。', 3, '面积花园星', 5, 'math-grade3-operations'),
       ...
       ('chinese-grade3-main-idea-001', '主要内容雷达', '主要内容雷达', 'available', '读一小段话，选择最能概括主要内容的句子。', 2, '概括雷达星', 3, 'chinese-grade3-reading'),
       ...
       ('chinese-grade3-writing-order-001', '顺序观察表达', '顺序观察表达', 'available', '用先、接着、最后把观察顺序说清楚。', 2, '顺序表达星', 3, 'chinese-grade3-expression'),
       ...
       ('english-grade3-listening-001', '日常句听辨', '日常句听辨', 'available', '听日常短句，选择听到的英语句子。', 2, '句子听辨星', 3, 'english-grade3-sentences'),
       ('english-grade3-question-001', '一般疑问句转换', '一般疑问句转换', 'available', '把陈述句转换成一般疑问句。', 2, '问句转换星', 4, 'english-grade3-sentences'),
       ...
       ('math-grade4-decimal-compare-001', '小数大小比较', '小数大小比较', 'available', '比较十分位、百分位，找出最大的小数。', 3, '小数比较星', 2, 'math-grade4-numbers'),
       ('math-grade4-angle-001', '角与图形', '角度观察屋', 'available', '认识锐角、直角和钝角，在图形里找角。', 3, '角度观察星', 2, 'math-grade4-numbers'),
       ('math-grade4-parallel-001', '平行与垂直', '平行与垂直', 'available', '认识平行、垂直和相交关系。', 3, '直线关系星', 5, 'math-grade4-numbers'),
       ...
       ('chinese-grade4-central-clue-001', '中心线索站', '中心线索站', 'available', '读海边短文，找出贯穿全文的线索词。', 2, '线索观察星', 3, 'chinese-grade4-reading'),
       ...
       ('chinese-grade4-poem-image-001', '古诗意象理解', '古诗意象理解', 'available', '从诗句里找画面，理解古诗意象。', 2, '诗意画面星', 3, 'chinese-grade4-expression'),
       ...
       ('english-grade4-listening-judgment-001', '时态关键词听辨', '时态关键词听辨', 'available', '听句子，抓住表示过去时间的关键词。', 2, '时态听辨星', 3, 'english-grade4-language'),
       ...
       ('english-grade4-scene-dialogue-001', '购物场景对话', '购物场景对话', 'available', '按顺序跟读购物场景三句话。', 2, '场景表达星', 3, 'english-grade4-expression');
...
update levels set display_order = 2 where code = 'math-grade4-decimal-compare-001';
update levels set display_order = 3 where code = 'math-grade4-hundredths-001';
update levels set display_order = 4 where code = 'math-grade4-angle-001';
update levels set display_order = 5 where code = 'math-grade4-angle-classify-001';
update levels set display_order = 6 where code = 'math-grade4-parallel-001';
...
insert into level_steps (id, step_code, step_type, prompt, display_order, level_code)
values (120, 'step-1', 'tap-choice', '不用一个个数，先看成 3 和 3，再选出总数。', 1, 'math-subitizing-001'),
       (121, 'step-1', 'equation-choice', '看数字小屋，6 已经分出 4，另一边应该是几？', 1, 'math-part-whole-001'),
       (122, 'step-1', 'story-choice', '看图先说故事：4 只小猫在玩，又跑来 3 只。', 1, 'math-picture-addition-001');

insert into level_steps (id, step_code, step_type, prompt, display_order, level_code)
values (123, 'step-1', 'tap-choice', '一本练习本 6 元，一支铅笔 2 元，一共要付多少元？', 1, 'math-grade1-money-001'),
       (124, 'step-1', 'story-choice', '时钟从 7 点走到 9 点，经过了几个小时？', 1, 'math-grade1-time-001'),
       (125, 'step-1', 'tap-choice', '两个一样的三角形可以拼成哪种常见图形？', 1, 'math-grade1-shape-001');

insert into level_steps (id, step_code, step_type, prompt, display_order, level_code)
values (126, 'step-1', 'listen-choice', '听老师读 ai，选出正确韵母。', 1, 'chinese-grade1-finals-001'),
       (127, 'step-1', 'tap-choice', '给“一条小鱼”选择正确的量词。', 1, 'chinese-grade1-measure-word-001'),
       (128, 'step-1', 'sentence-read', '按顺序读完三句看图说话。', 1, 'chinese-grade1-picture-speaking-001'),
       (129, 'step-1', 'listen-choice', '听 /æ/ 的声音，选出对应单词。', 1, 'english-grade1-short-vowel-001'),
       (130, 'step-1', 'drag-match', '把 one、two、red 和图片连起来。', 1, 'english-grade1-number-color-001'),
       (131, 'step-1', 'sentence-read', '按顺序跟读课堂小对话。', 1, 'english-grade1-dialogue-001');

insert into level_steps (id, step_code, step_type, prompt, display_order, level_code)
values (132, 'step-1', 'story-choice', '12 个苹果平均分给 3 个小朋友，每人几个？', 1, 'math-grade2-division-001'),
       (133, 'step-1', 'tap-choice', '看水果统计图，哪种水果最多？', 1, 'math-grade2-statistics-001'),
       (134, 'step-1', 'tap-choice', '“你今天开心吗”后面应该加什么标点？', 1, 'chinese-grade2-punctuation-001'),
       (135, 'step-1', 'tap-choice', '读短段，找出中心句。', 1, 'chinese-grade2-main-idea-001'),
       (136, 'step-1', 'listen-choice', 'Listen and choose: rice.', 1, 'english-grade2-food-listening-001'),
       (137, 'step-1', 'sentence-read', '按顺序跟读动物问答。', 1, 'english-grade2-animal-dialogue-001');

insert into level_steps (id, step_code, step_type, prompt, display_order, level_code)
values (138, 'step-1', 'story-choice', '17 个橘子每 5 个装一袋，可以装满几袋，还剩几个？', 1, 'math-grade3-remainder-001'),
       (139, 'step-1', 'story-choice', '长方形花坛长 8 米、宽 3 米，面积是多少平方米？', 1, 'math-grade3-area-001'),
       (140, 'step-1', 'tap-choice', '读秋游短文，选出最能概括内容的一句。', 1, 'chinese-grade3-main-idea-001'),
       (141, 'step-1', 'sentence-read', '按顺序读完观察小蚂蚁的三句话。', 1, 'chinese-grade3-writing-order-001'),
       (142, 'step-1', 'listen-choice', 'Listen and choose: I go to school by bus.', 1, 'english-grade3-listening-001'),
       (143, 'step-1', 'tap-choice', '找到 You like apples. 的一般疑问句。', 1, 'english-grade3-question-001');

insert into level_steps (id, step_code, step_type, prompt, display_order, level_code)
values (144, 'step-1', 'tap-choice', '0.6、0.48、0.75 中，哪个小数最大？', 1, 'math-grade4-decimal-compare-001'),
       (145, 'step-1', 'tap-choice', '找到“两条直线永不相交”的关系。', 1, 'math-grade4-parallel-001'),
       (146, 'step-1', 'tap-choice', '读海边短文，选出贯穿全文的线索词。', 1, 'chinese-grade4-central-clue-001'),
       (147, 'step-1', 'tap-choice', '“月落乌啼霜满天”主要写出了什么画面？', 1, 'chinese-grade4-poem-image-001'),
       (148, 'step-1', 'listen-choice', 'Listen and choose the sentence with last Sunday.', 1, 'english-grade4-listening-judgment-001'),
       (149, 'step-1', 'sentence-read', '按顺序跟读购物场景三句话。', 1, 'english-grade4-scene-dialogue-001');
...
update level_steps
set activity_config_json = '{"kind":"number-choice","assetTheme":"数感闪电眼","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"不用一个个数，先看成 3 和 3，再选出总数。","choices":[5,6,7],"correctChoice":6,"optionLabelPrefix":"数字卡","successFeedback":"真快，3 和 3 合起来就是 6。","failureFeedback":"先把上面 3 个和下面 3 个分开看，再合起来。","pictureGroups":[{"label":"上面 3 个点","emoji":"🔵","count":3,"tone":"normal"},{"label":"下面 3 个点","emoji":"🔵","count":3,"tone":"add"}]}',
    knowledge_point_code = 'math.preschool.number-sense.subitizing',
    knowledge_point_title = '数学数感：快速看数量',
    variant_count = 8
where level_code = 'math-subitizing-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"equation-choice","assetTheme":"数字分合小屋","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"看数字小屋，6 已经分出 4，另一边应该是几？","choices":["6 = 4 + 2","6 = 4 + 1","6 = 3 + 2"],"correctChoice":"6 = 4 + 2","successFeedback":"答对了，4 和 2 合起来就是 6。","failureFeedback":"从 4 往后数到 6，还差几个？"}',
    knowledge_point_code = 'math.preschool.number-sense.part-whole',
    knowledge_point_title = '数学数感：数的分合',
    variant_count = 8
where level_code = 'math-part-whole-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"story-choice","assetTheme":"小猫加法故事","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"看图先说故事：4 只小猫在玩，又跑来 3 只。","emoji":"🐱","characterLabel":"小猫操场","detailLines":["先看到 4 只小猫。","又跑来 3 只小猫。","把两组小猫合起来数一数。"],"choices":[6,7,8],"correctChoice":7,"successFeedback":"答对了，4 + 3 = 7，小猫都到齐啦。","failureFeedback":"先数原来有几只，再把新来的小猫加进去。","pictureGroups":[{"label":"原来在玩的猫","emoji":"🐱","count":4,"tone":"normal"},{"label":"新跑来的猫","emoji":"🐈","count":3,"tone":"add"},{"label":"合起来的小猫","emoji":"🐱","count":7,"tone":"result"}]}',
    knowledge_point_code = 'math.preschool.operations.picture-addition',
    knowledge_point_title = '数学运算：看图加法',
    variant_count = 8
where level_code = 'math-picture-addition-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"number-choice","assetTheme":"人民币小商店","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"一本练习本 6 元，一支铅笔 2 元，一共要付多少元？","choices":[7,8,9],"correctChoice":8,"optionLabelPrefix":"价格卡","successFeedback":"答对了，6 元 + 2 元 = 8 元","failureFeedback":"先看练习本 6 元，再加上铅笔 2 元。","pictureGroups":[{"label":"练习本价格","emoji":"📘","count":6,"tone":"normal"},{"label":"铅笔价格","emoji":"✏️","count":2,"tone":"add"}]}',
    knowledge_point_code = 'math.g1.life.money-yuan',
    knowledge_point_title = '一年级生活数学：人民币初步',
    variant_count = 8
where level_code = 'math-grade1-money-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"story-choice","assetTheme":"整点时间站","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"时钟从 7 点走到 9 点，经过了几个小时？","emoji":"🕘","characterLabel":"整点时钟","detailLines":["从 7 点到 8 点是 1 小时。","从 8 点到 9 点又是 1 小时。"],"choices":[1,2,3],"correctChoice":2,"successFeedback":"答对了，从 7 点到 9 点经过 2 小时","failureFeedback":"可以从 7 点开始，一小时一小时往后数。"}',
    knowledge_point_code = 'math.g1.life.whole-hour',
    knowledge_point_title = '一年级生活数学：整点时间',
    variant_count = 8
where level_code = 'math-grade1-time-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"character-choice","assetTheme":"图形拼拼站","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"两个一样的三角形可以拼成哪种常见图形？","choices":[{"label":"长方形","hint":"两块三角板可以拼成长长的四边形"},{"label":"圆形","hint":"圆圆的，没有角"},{"label":"五角星","hint":"尖角很多，不是两块三角形常见拼法"}],"correctChoice":"长方形","successFeedback":"答对了，两个一样的三角形可以拼成长方形","detailLines":["先把两个三角形的长边靠在一起。","外面就能看到一个长方形的轮廓。"],"failureFeedback":"先想想两个三角形拼在一起，外面的边会变成什么样。"}',
    knowledge_point_code = 'math.g1.geometry.shape-compose',
    knowledge_point_title = '一年级图形应用：图形拼组',
    variant_count = 8
where level_code = 'math-grade1-shape-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"listen-choice","assetTheme":"韵母听辨站","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"听老师读 ai，选出正确韵母。","audioPrompt":"ai","audioText":"ai","lang":"zh-CN","playButtonLabel":"播放韵母","choices":["ai","ei","ao"],"correctChoice":"ai","successFeedback":"听对了，ai 像“挨着”的 ai","failureFeedback":"再听一遍，先听开头 a，再滑到 i。"}',
    knowledge_point_code = 'chinese.g1.pinyin.compound-finals',
    knowledge_point_title = '一年级拼音：复韵母听辨',
    variant_count = 8
where level_code = 'chinese-grade1-finals-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"character-choice","assetTheme":"量词搭配桥","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"给“一条小鱼”选择正确的量词。","choices":[{"label":"条","hint":"一条小鱼"},{"label":"朵","hint":"一朵花"},{"label":"本","hint":"一本书"}],"correctChoice":"条","successFeedback":"答对了，小鱼常说“一条小鱼”","detailLines":["量词要和后面的事物搭配。","鱼、河、路常用“条”。"],"failureFeedback":"想一想，平时我们会说一什么小鱼？"}',
    knowledge_point_code = 'chinese.g1.words.measure-word',
    knowledge_point_title = '一年级词语：量词搭配',
    variant_count = 8
where level_code = 'chinese-grade1-measure-word-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"sentence-read","assetTheme":"看图说一句","audioQuality":"高质量儿童 TTS","variantCount":6,"instruction":"看图先找人物、地点和动作，再把句子读出来。","sentences":[{"text":"早上，小明来到学校。","emoji":"🏫","scene":"小明背着书包到校门口"},{"text":"他和老师说早上好。","emoji":"👩‍🏫","scene":"小明向老师问好"},{"text":"同学们一起走进教室。","emoji":"📚","scene":"大家准备上课"}],"successFeedback":"看图说话读顺啦，人物、地点和动作都找到了"}',
    knowledge_point_code = 'chinese.g1.expression.picture-speaking',
    knowledge_point_title = '一年级表达：看图说话',
    variant_count = 6
where level_code = 'chinese-grade1-picture-speaking-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"listen-choice","assetTheme":"短元音听辨","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"听 /æ/ 的声音，选出对应单词。","audioPrompt":"/æ/","audioText":"cat","lang":"en-US","playButtonLabel":"播放短元音单词","choiceAriaLabelPrefix":"短元音单词","choices":["cat","bed","pig"],"correctChoice":"cat","successFeedback":"听对了，cat 里有短短的 /æ/","failureFeedback":"再听一遍，cat 的嘴巴要打开一点。"}',
    knowledge_point_code = 'english.g1.phonics.short-vowels',
    knowledge_point_title = '一年级英语：短元音听辨',
    variant_count = 8
where level_code = 'english-grade1-short-vowel-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"word-match","assetTheme":"数字颜色配对","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"先点英文词，再点对应图片。","pairs":[{"word":"one","pictureLabel":"一个星星","emoji":"⭐","phonetic":"/wʌn/"},{"word":"two","pictureLabel":"两个气球","emoji":"🎈","phonetic":"/tuː/"},{"word":"red","pictureLabel":"红色蜡笔","emoji":"🟥","phonetic":"/red/"}]}',
    knowledge_point_code = 'english.g1.words.number-color',
    knowledge_point_title = '一年级英语：数字颜色词',
    variant_count = 8
where level_code = 'english-grade1-number-color-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"sentence-read","assetTheme":"课堂对话跟读","audioQuality":"高质量儿童 TTS","variantCount":6,"instruction":"像课堂对话一样，点一句、听一句、跟一句。","sentences":[{"text":"May I come in?","emoji":"🚪","scene":"进教室前礼貌询问"},{"text":"Sit down, please.","emoji":"🪑","scene":"老师请同学坐下"},{"text":"Open your book.","emoji":"📘","scene":"打开书准备学习"}],"successFeedback":"课堂小对话跟读完成啦"}',
    knowledge_point_code = 'english.g1.speaking.classroom-dialogue',
    knowledge_point_title = '一年级英语：课堂日常表达',
    variant_count = 6
where level_code = 'english-grade1-dialogue-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"story-choice","assetTheme":"平均分餐桌","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"12 个苹果平均分给 3 个小朋友，每人几个？","emoji":"🍎","characterLabel":"平均分餐桌","detailLines":["先把 12 个苹果分成 3 份。","每份一样多，就是平均分。"],"choices":[3,4,5],"correctChoice":4,"successFeedback":"答对了，12 平均分成 3 份，每份 4 个","failureFeedback":"可以 3 个小朋友轮流每人拿 1 个，数数每人最后有几个。"}',
    knowledge_point_code = 'math.g2.operations.division-equal-share',
    knowledge_point_title = '二年级运算：平均分除法',
    variant_count = 8
where level_code = 'math-grade2-division-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"character-choice","assetTheme":"统计图读数","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"看水果统计图，哪种水果最多？","choices":[{"label":"苹果","hint":"5 个"},{"label":"香蕉","hint":"8 个"},{"label":"梨","hint":"6 个"}],"correctChoice":"香蕉","successFeedback":"答对了，香蕉有 8 个，是最多的","detailLines":["读统计图时先看每一类有几个。","再比较数量大小。"],"failureFeedback":"先比较 5、8、6，哪个数最大？"}',
    knowledge_point_code = 'math.g2.statistics.chart-reading',
    knowledge_point_title = '二年级统计：读图比较',
    variant_count = 8
where level_code = 'math-grade2-statistics-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"character-choice","assetTheme":"标点语气站","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"“你今天开心吗”后面应该加什么标点？","choices":[{"label":"？","hint":"问号"},{"label":"。","hint":"句号"},{"label":"！","hint":"感叹号"}],"correctChoice":"？","successFeedback":"答对了，这是在提问，要用问号","detailLines":["看到“吗”，通常表示问题。"],"failureFeedback":"这句话是在问别人，要选能表示提问的标点。"}',
    knowledge_point_code = 'chinese.g2.expression.punctuation-tone',
    knowledge_point_title = '二年级表达：标点语气',
    variant_count = 8
where level_code = 'chinese-grade2-punctuation-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"character-choice","assetTheme":"中心句小雷达","audioQuality":"高质量儿童 TTS","variantCount":6,"instruction":"读短段，找出中心句。","choices":[{"label":"小松鼠很勤劳。","hint":"能概括整段意思"},{"label":"它摘了三个松果。","hint":"只是一个细节"},{"label":"树林里有风。","hint":"不是主要内容"}],"correctChoice":"小松鼠很勤劳。","successFeedback":"答对了，这句话能概括整段主要意思","detailLines":["中心句常常能说出这一段主要讲什么。"],"failureFeedback":"找一找哪一句能把整段意思都说出来。"}',
    knowledge_point_code = 'chinese.g2.reading.main-idea',
    knowledge_point_title = '二年级阅读：中心句初步',
    variant_count = 6
where level_code = 'chinese-grade2-main-idea-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"listen-choice","assetTheme":"食物单词听辨","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"Listen and choose: rice.","audioPrompt":"rice","audioText":"rice","lang":"en-US","playButtonLabel":"播放食物单词","choiceAriaLabelPrefix":"食物单词","choices":["rice","milk","cake"],"correctChoice":"rice","successFeedback":"Good! rice is 米饭。","failureFeedback":"Listen again. rice starts with /r/."}',
    knowledge_point_code = 'english.g2.words.food-listening',
    knowledge_point_title = '二年级英语：食物词听辨',
    variant_count = 8
where level_code = 'english-grade2-food-listening-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"sentence-read","assetTheme":"动物对话跟读","audioQuality":"高质量儿童 TTS","variantCount":6,"instruction":"围绕喜欢的动物，跟读简单问答。","sentences":[{"text":"Do you like cats?","emoji":"🐱","scene":"询问是否喜欢猫"},{"text":"Yes, I do.","emoji":"😊","scene":"肯定回答"},{"text":"Cats are cute.","emoji":"🐾","scene":"描述猫很可爱"}],"successFeedback":"动物对话跟读完成啦"}',
    knowledge_point_code = 'english.g2.speaking.animal-dialogue',
    knowledge_point_title = '二年级英语：动物主题对话',
    variant_count = 6
where level_code = 'english-grade2-animal-dialogue-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"story-choice","assetTheme":"橘子装袋站","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"17 个橘子每 5 个装一袋，可以装满几袋，还剩几个？","emoji":"🍊","characterLabel":"橘子装袋站","detailLines":["先每 5 个装一袋。","17 里面有 3 个 5，还剩 2 个。"],"choices":[2,3,4],"correctChoice":3,"successFeedback":"答对了，17 ÷ 5 = 3 袋余 2 个","failureFeedback":"先数 5、10、15，看看离 17 还差几个。"}',
    knowledge_point_code = 'math.g3.operations.division-remainder',
    knowledge_point_title = '三年级运算：有余数除法',
    variant_count = 8
where level_code = 'math-grade3-remainder-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"story-choice","assetTheme":"长方形面积模型","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"长方形花坛长 8 米、宽 3 米，面积是多少平方米？","emoji":"🌷","characterLabel":"花坛面积格","detailLines":["可以看成 3 行，每行 8 格。","面积就是 8 × 3。"],"choices":[22,24,28],"correctChoice":24,"successFeedback":"答对了，8 × 3 = 24 平方米","failureFeedback":"长方形面积用长乘宽。","mathModel":{"kind":"grid","title":"长方形面积模型","caption":"8 列 × 3 行，一共有 24 个小方格","rows":3,"columns":8,"filledCount":24}}',
    knowledge_point_code = 'math.g3.geometry.rectangle-area',
    knowledge_point_title = '三年级图形：长方形面积',
    variant_count = 8
where level_code = 'math-grade3-area-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"character-choice","assetTheme":"主要内容雷达","audioQuality":"高质量儿童 TTS","variantCount":6,"instruction":"读秋游短文，选出最能概括内容的一句。","choices":[{"label":"同学们秋游时观察了美丽的公园。","hint":"能概括地点、人物和主要活动"},{"label":"小明带了一个水壶。","hint":"只是细节"},{"label":"树叶是黄色的。","hint":"只是一个画面"}],"correctChoice":"同学们秋游时观察了美丽的公园。","successFeedback":"答对了，这句话概括了人物、地点和主要活动","detailLines":["概括主要内容时，要抓住谁、在哪里、做了什么。"],"failureFeedback":"不要只选细节，要选能说完整段意思的句子。"}',
    knowledge_point_code = 'chinese.g3.reading.main-idea',
    knowledge_point_title = '三年级阅读：概括主要内容',
    variant_count = 6
where level_code = 'chinese-grade3-main-idea-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"sentence-read","assetTheme":"顺序观察表达","audioQuality":"高质量儿童 TTS","variantCount":6,"instruction":"按“先、接着、最后”的顺序读完观察小蚂蚁的三句话。","sentences":[{"text":"先看见一只小蚂蚁搬着米粒。","emoji":"🐜","scene":"先看到蚂蚁搬米粒"},{"text":"接着，它叫来了两个伙伴。","emoji":"👀","scene":"接着伙伴来了"},{"text":"最后，大家一起把米粒搬回洞里。","emoji":"🏡","scene":"最后搬回洞里"}],"successFeedback":"顺序表达完成，观察过程说清楚了"}',
    knowledge_point_code = 'chinese.g3.expression.sequence-writing',
    knowledge_point_title = '三年级表达：按顺序写观察',
    variant_count = 6
where level_code = 'chinese-grade3-writing-order-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"listen-choice","assetTheme":"日常句听辨","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"Listen and choose: I go to school by bus.","audioPrompt":"I go to school by bus.","audioText":"I go to school by bus.","lang":"en-US","playButtonLabel":"播放日常句","choiceAriaLabelPrefix":"英语句子","choices":["I go to school by bus.","I go home by bike.","I read books at school."],"correctChoice":"I go to school by bus.","successFeedback":"Good! You heard school and bus.","failureFeedback":"Listen for the words school and bus."}',
    knowledge_point_code = 'english.g3.listening.daily-sentence',
    knowledge_point_title = '三年级英语：日常句听辨',
    variant_count = 8
where level_code = 'english-grade3-listening-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"character-choice","assetTheme":"一般疑问句转换","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"找到 You like apples. 的一般疑问句。","choices":[{"label":"Do you like apples?","hint":"Do 放到句首，形成一般疑问句"},{"label":"You do like apples.","hint":"这是强调句"},{"label":"You like apples?","hint":"口语里可用，但不是标准转换"}],"correctChoice":"Do you like apples?","successFeedback":"答对了，一般疑问句要把 Do 放到句首","detailLines":["You like apples. 变问句时，在句首加 Do。"],"failureFeedback":"找一找哪一句以 Do 开头，并且句末是问号。"}',
    knowledge_point_code = 'english.g3.sentences.question-transform',
    knowledge_point_title = '三年级英语：一般疑问句转换',
    variant_count = 8
where level_code = 'english-grade3-question-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"number-choice","assetTheme":"小数比较灯塔","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"0.6、0.48、0.75 中，哪个小数最大？","choices":[0.6,0.48,0.75],"correctChoice":0.75,"optionLabelPrefix":"小数卡","successFeedback":"答对了，0.75 最大，因为 75 个百分之一比 60 个百分之一更多","failureFeedback":"可以先把 0.6 看成 0.60，再比较百分位。"}',
    knowledge_point_code = 'math.g4.decimal.compare',
    knowledge_point_title = '四年级小数：大小比较',
    variant_count = 8
where level_code = 'math-grade4-decimal-compare-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"character-choice","assetTheme":"直线关系站","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"找到“两条直线永不相交”的关系。","choices":[{"label":"平行","hint":"两条线保持一样远"},{"label":"垂直","hint":"相交成直角"},{"label":"相交","hint":"两条线会碰到一起"}],"correctChoice":"平行","successFeedback":"答对了，永不相交的两条直线互相平行","detailLines":["平行线之间的距离处处相等。"],"failureFeedback":"想一想铁路轨道的两条线。"}',
    knowledge_point_code = 'math.g4.geometry.parallel-perpendicular',
    knowledge_point_title = '四年级图形：平行与垂直',
    variant_count = 8
where level_code = 'math-grade4-parallel-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"character-choice","assetTheme":"中心线索站","audioQuality":"高质量儿童 TTS","variantCount":6,"instruction":"读海边短文，选出贯穿全文的线索词。","choices":[{"label":"海风","hint":"开头、中间、结尾都出现并推动画面"},{"label":"贝壳","hint":"只是一个细节"},{"label":"书包","hint":"不是全文重点"}],"correctChoice":"海风","successFeedback":"答对了，海风贯穿全文，是这段文字的线索","detailLines":["线索常常把多个画面串在一起。"],"failureFeedback":"找一找哪个词反复出现，并连接了不同画面。"}',
    knowledge_point_code = 'chinese.g4.reading.central-clue',
    knowledge_point_title = '四年级阅读：中心与线索',
    variant_count = 6
where level_code = 'chinese-grade4-central-clue-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"character-choice","assetTheme":"古诗意象理解","audioQuality":"高质量儿童 TTS","variantCount":6,"instruction":"“月落乌啼霜满天”主要写出了什么画面？","choices":[{"label":"夜晚清冷的江边景象","hint":"月落、乌啼、霜满天都让画面清冷"},{"label":"热闹的春游场景","hint":"和诗句氛围不符"},{"label":"中午阳光很强","hint":"诗句写的是夜晚"}],"correctChoice":"夜晚清冷的江边景象","successFeedback":"答对了，这句诗写出夜晚清冷的画面","detailLines":["读古诗可以先抓景物，再感受氛围。"],"failureFeedback":"看看月落、乌啼、霜这些景物带来什么感觉。"}',
    knowledge_point_code = 'chinese.g4.poem.imagery',
    knowledge_point_title = '四年级古诗：意象理解',
    variant_count = 6
where level_code = 'chinese-grade4-poem-image-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"listen-choice","assetTheme":"时态关键词听辨","audioQuality":"高质量儿童 TTS","variantCount":8,"instruction":"Listen and choose the sentence with last Sunday.","audioPrompt":"I visited my grandma last Sunday.","audioText":"I visited my grandma last Sunday.","lang":"en-US","playButtonLabel":"播放时态关键词句","choiceAriaLabelPrefix":"英语句子","choices":["I visited my grandma last Sunday.","I visit my grandma every Sunday.","I will visit my grandma tomorrow."],"correctChoice":"I visited my grandma last Sunday.","successFeedback":"Good! last Sunday tells us it happened in the past.","failureFeedback":"Listen for last Sunday and visited."}',
    knowledge_point_code = 'english.g4.listening.tense-keyword',
    knowledge_point_title = '四年级英语：时态关键词听辨',
    variant_count = 8
where level_code = 'english-grade4-listening-judgment-001' and step_code = 'step-1';

update level_steps
set activity_config_json = '{"kind":"sentence-read","assetTheme":"购物场景对话","audioQuality":"高质量儿童 TTS","variantCount":6,"instruction":"按顺序跟读购物场景三句话。","sentences":[{"text":"Can I help you?","emoji":"🛍️","scene":"店员询问需要帮助吗"},{"text":"I want a blue pencil.","emoji":"✏️","scene":"说出想买的物品"},{"text":"Here you are.","emoji":"🤲","scene":"递给对方物品"}],"successFeedback":"购物场景对话跟读完成啦"}',
    knowledge_point_code = 'english.g4.expression.scene-dialogue',
    knowledge_point_title = '四年级英语：场景对话表达',
    variant_count = 6
where level_code = 'english-grade4-scene-dialogue-001' and step_code = 'step-1';
